...
def env_key_for_perf() -> str:
    ...
    Changes to smoothing, tension, monotone enforcement, node-lock flags or
    CODE_VERSION produce a different key, causing cached models built under
    the old settings to be treated as stale.
    """
