...
function mount(rootEl) {
  ...
  if (shell) {
    ...
    // 确保 spectrumRoot 也被移入 stack（如果 spectrumRoot 已是 shell 的直接子元素则保持原位）
    // In the new chart-upper-row layout, #spectrumHost is a sibling of .chart-upper-row inside the shell
