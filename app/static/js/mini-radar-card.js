...
(function initMiniRadarCardSystem() {
  ...
  // The mini-radar _LABEL_SLOTS below are indexed in CW order (UL→UR→R→LR→LL→L).
  // To map canonical CCW slot i to CW label-slot j: CW[j] = CCW[(n-j) % n].
  ...
  // RADAR_CIDS_COLOR: CW order used together with _LABEL_SLOTS for label rendering.
