...
(function(global){
  const LS_KEYS = {
    ...
    // Radar selection – only model identity + active conditions are persisted (no scores)
    RADAR_MODELS: 'fc_radar_models_v1',  // [{modelId, brand, label}]
